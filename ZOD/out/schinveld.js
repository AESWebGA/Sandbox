        ...
        var exports3 = module3.exports = function(iterable, entries, fn, that, ITERATOR2) {
          ...
          if (_isArrayIter(iterFn))
            ...
            for (iterator = iterFn.call(iterable); !(step = iterator.next()).done; ) {
              result = _iterCall(iterator, f2, step.value, entries);
              if (result === BREAK || result === RETURN)
                return result;
            }
        };
...
import_jquery.default.getJSON("https://api.open-meteo.com/v1/forecast?latitude=50.97&longitude=5.98&hourly=temperature_2m,rain&past_days=1&forecast_days=5&timezone=Europe%2FBerlin", (data) => {
...
function drawChart() {
  let mappedData = weatherArrayStore.map((value) => {
    return [(0, import_moment.default)(value.time).format("lll"), value.temp, value.rain];
  });
...
moment/moment.js:
  ...
  (*! momentjs.com *)
*/
//# sourceMappingURL=schinveld.js.map
